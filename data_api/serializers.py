...
from .models import Podcast,UserProfileInfo,Ad,Compaign,EpisodeStat,PodcastStatGeneral,Episode,Message,AgeGroup,Education
...
class CompaignSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Compaign
        fields = ('id','name','type','description','startDate', 'message_set','announcer','podcast','status','educationLevel','ageGroup')
